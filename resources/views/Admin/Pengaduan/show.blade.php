                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                <th>Foto</th>
                                <td>:</td>
                                <td><img src="{{ asset('img/pengaduan/' .$pengaduan->foto) }}" alt="Foto Pengaduan" class="embed-responsive"></td>
                            </tr>
                            <tr>
                                <th>Judul Laporan</th>
                                <td>:</td>
                ...
                <div class="card-body">
                    <form action="{{ route('tanggapan.createOrUpdate') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="tanggapan" id="tanggapan" rows="4" class="form-control @error('tanggapan') is-invalid @enderror" placeholder="Belum ada tanggapan">{{ $tanggapan->tanggapan ?? '' }}</textarea>
                            @error('tanggapan')
                                <small class="text-danger">{{$message}}</small>
                            @enderror
                        </div>
